...
export function synchronize(s?: Stream): void;
...
export function add(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
...
export function allclose(a: ScalarOrArray, b: ScalarOrArray, rtol?: number, atol?: number, equalNan?: boolean, s?: StreamOrDevice): boolean;
...
export function arrayEqual(a: ScalarOrArray, b: ScalarOrArray, equalNan?: boolean, s?: StreamOrDevice): array;
...
export function bitwiseAnd(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
export function bitwiseOr(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
export function bitwiseXor(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
export function broadcastTo(array: ScalarOrArray, shape: number | number[], s?: StreamOrDevice): array;
export function blockMaskedMM(a: ScalarOrArray, b: ScalarOrArray, blockSize: number, maskOut?: ScalarOrArray, maskLhs?: ScalarOrArray, maskRhs?: ScalarOrArray, s?: StreamOrDevice): array;
...
export function convolve(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
...
export function degrees(array: ScalarOrArray, s?: StreamOrDevice): array;
...
export function divide(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
export function divmod(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): [array, array];
export function equal(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
export function notEqual(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
...
export function floorDivide(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
export function full(shape: number | number[], fillValue: ScalarOrArray, dtype?: Dtype, s?: StreamOrDevice): array;
export function greater(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
export function greaterEqual(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
export function identity(n: number, dtype?: Dtype, s?: StreamOrDevice): array;
export function inner(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
export function isclose(a: ScalarOrArray, b: ScalarOrArray, rtol?: number, atol?: number, equalNan?: boolean, s?: StreamOrDevice): array;
...
export function leftShift(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
export function less(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
export function lessEqual(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
...
export function logaddexp(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
export function logicalNot(array: ScalarOrArray, s?: StreamOrDevice): array;
export function logicalAnd(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
export function logicalOr(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
export function logsumexp(array: ScalarOrArray, s?: StreamOrDevice): array;
export function matmul(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
...
export function maximum(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
...
export function minimum(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
export function moveaxis(array: ScalarOrArray, source: number | number[], destination: number | number[], s?: StreamOrDevice): array;
export function multiply(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
...
export function outer(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
...
export function quantizedMatmul(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
export function radians(array: ScalarOrArray, s?: StreamOrDevice): array;
export function reciprocal(array: ScalarOrArray, s?: StreamOrDevice): array;
export function remainder(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
...
export function rightShift(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
...
export function subtract(a: ScalarOrArray, b: ScalarOrArray, s?: StreamOrDevice): array;
...
export function tensordot(a: ScalarOrArray, b: ScalarOrArray, axes?: number | [number | number[], number | number[]], s?: StreamOrDevice): array;
